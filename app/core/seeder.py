...
async def ensure_role(db: AsyncSession, nama_role: str, level: int) -> Role:
...
async def seed_initial_data(db: AsyncSession) -> None:
    """
    Seed initial data to database if empty or missing.
    Ensures roles, default admin/seller/buyer accounts, stock items, products, and FAQs.
    """
    ...
    # Recalculate HPP for Lapis Legit
